...
import com.project.parking.activity.RefreshingMallActivity;
...
public class MenuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGridMenuFragment.setOnClickMenuListener(new GridMenuFragment.OnClickMenuListener() {
           ...
           else if(Constants.CODE_REFRESHING_CACHE_MALL.equals(gridMenu.getCode())){
               i = new Intent(MenuActivity.this, RefreshingMallActivity.class);
           }
            startActivity(i);
            finish();
    ...
    private void setupGridMenu() {
        ...
        // menu yang di tampilkan berdasarkan group usernya..
        ...
        if(loginData.getGroupUser().equalsIgnoreCase(Constants.USER)){
            ...
            menus.add(new GridMenu(Constants.CODE_CHECK_IN, MenuActivity.this.getResources().getString(R.string.buton_menu_check_in), R.drawable.groups));
            menus.add(new GridMenu(Constants.CODE_REFRESHING_CACHE_MALL, MenuActivity.this.getResources().getString(R.string.buton_menu_refreshing_mall), R.drawable.lists));
        }
...
//    }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            if (mBackPressed + TIME_INTERVAL > System.currentTimeMillis()) {
                Intent goToLogin = new Intent(this.getApplicationContext(), MainFragment.class);
                goToLogin.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(goToLogin);
                finish();
            }else {
